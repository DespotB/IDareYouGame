  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body: Center(
          child: Text('First Screen', style: TextStyle(fontSize: 18.00)),
        ),
      ),
    );
  }
              ...
              child: new Column(
                  children: [
                    ...
                    new Text(
                      ...
                      style: new TextStyle(color: Color(0xFF3d5d72), fontSize: 25.0),
                    ),
                    new Padding(padding: EdgeInsets.only(top: 20.0)),
                              ...
                              Container(
                                ...
                                child: TextFormField(style: TextStyle(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    prefixIcon: Icon(Icons.accessibility_new_outlined, color: Colors.white),
